...
BOT_USERNAME = getenv("BOT_USERNAME" , "KITKAT_MUSIC_BOT")

# Get Your repo
REPO_LINK = getenv("REPO_LINK" , "https://te.legra.ph/file/4b225214f22ad8bbc8a86.mp4")

# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "KITKAT_MUSIC_BOT")
...
OWNER_ID = int(getenv("OWNER_ID", 6433467226))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/BRANDED-THUNDER/Kit-kat-music-bot",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/kit_kat_2170")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/best_song_chat")
